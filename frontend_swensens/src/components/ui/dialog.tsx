...
>(({ className, ...props }, ref) => (
	<DialogPrimitive.Title
		...
		className={cn(
			...
			"w-full whitespace-pre-wrap text-display-small text-text-primary break-words",
			className
		)}
		{...props}
	/>
