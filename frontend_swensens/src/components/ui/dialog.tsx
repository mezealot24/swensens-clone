...
>(({ className, ...props }, ref) => (
	<DialogPrimitive.Title
		ref={ref}
		className={cn(
			"text-3xl font-semibold leading-tight tracking-[0.05em]", // ปรับ tracking เป็นค่าลบเพื่อให้ตัวอักษรชิดกันมากขึ้น
